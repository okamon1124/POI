...
public class StateMachine<TOwner>
{
    ...
    public event System.Action<State, State, int> OnStateChanged;
    ...
    private void Change(State nextState, int eventId)
    {
        var prev = CurrentState;
        prev?.Exit(nextState);
        nextState.Enter(prev);
        CurrentState = nextState;

        // fire debug hook
        OnStateChanged?.Invoke(prev, nextState, eventId);
    }
}
